...
auto tilebox_event_mask_from_xlib_eventmask(const std::int64_t event_mask) -> X11InputEventMask
{
    switch (event_mask)
    {
    case NoEventMask:
...
auto tilebox_event_mask_to_xlib_eventmask(const X11InputEventMask event_mask) -> std::int64_t
{
    switch (event_mask)
    {
...
auto tilebox_event_from_xlib_event(const std::int32_t event_type) noexcept -> X11EventType
{
    switch (event_type)
    {
    case KeyPress:
...
auto tilebox_event_to_xlib_event(const X11EventType event_type) noexcept -> std::int32_t
{
    switch (event_type)
    {
