function(run_clang_tidy DIRECTORY NAME)
    ...
    if(CLANG_TIDY)
        ...
        add_custom_command(
            TARGET ${NAME}
            POST_BUILD
            COMMAND ${CMAKE_COMMAND} -E cmake_echo_color --blue "Running clang-tidy on all sources in ${DIRECTORY}"
            COMMAND ${CMAKE_COMMAND} -E echo ""
            COMMAND clang-tidy -p ${CMAKE_BINARY_DIR} -header-filter=.* --config-file=${CMAKE_SOURCE_DIR}/.clang-tidy
                    ${ALL_FILES})
